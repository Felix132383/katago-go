import { KataGoBinModelParser, parseActivationKind, parseBatchNormV8, parseConv2d, parseMatBias, parseMatMul } from './binModelParser.js';
export function parseKataGoModelV8(data) {
